...
#define AI_NETWORK_MODEL_SIGNATURE     "0x4a01cd7dec81aacc3c81729c0aa6f5b3"
...
#define AI_TOOLS_DATE_TIME   "2026-05-05T22:14:16+0500"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 2, 16, 1, 1), AI_STRIDE_INIT(4, 4, 8, 128, 128),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 396, 1, 1),
    396, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 76, 1, 1),
    76, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_2_output),
  &gemm_0_layer, 0x86061e93, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 4);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4);
    ...
    nl_2_output_array.data = AI_PTR(g_network_activations_map[0] + 12);
    nl_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 128);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 192);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 192);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 384);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 384);
    return true;
  }
